...
import trainers.BiomedCoOp.biomedcoop_copy
...
def extend_cfg(cfg):
    ...
    cfg.TRAINER.BIOMEDCOOP.ATT_INIT = ""
    ...
    cfg.TRAINER.BIOMEDCOOP.N_PROMPTS = 10

    # Attribute learning parameters
    cfg.TRAINER.BIOMEDCOOP.ATTR_LEARNING = False  # Enable attribute learning
    cfg.TRAINER.BIOMEDCOOP.ATTR_LAMBDA = 0.5  # Weight for attribute learning loss
    cfg.TRAINER.BIOMEDCOOP.ATTR_DIM = 64  # Dimension of attribute embeddings
    cfg.TRAINER.BIOMEDCOOP.ATTR_TEMP = 0.07  # Temperature parameter for attribute learning
    cfg.TRAINER.BIOMEDCOOP.ATTR_MARGIN = 0.2  # Margin for triplet loss
    cfg.TRAINER.BIOMEDCOOP.N_ATT = 4
    cfg.TRAINER.BIOMEDCOOP.ATT1_TEXT = "shape"
    cfg.TRAINER.BIOMEDCOOP.ATT2_TEXT = "color"
    cfg.TRAINER.BIOMEDCOOP.ATT3_TEXT = "material"
    cfg.TRAINER.BIOMEDCOOP.ATT4_TEXT = "function"
    cfg.TRAINER.BIOMEDCOOP.ATT5_TEXT = "texture"
    ...
    cfg.TRAINER.BIOMEDCOOP.STAGE=2  # 1 or 2
...
if __name__ == "__main__":
    ...
    parser.add_argument("--root", type=str, default="/home/diaoyueqin/dyq/BiomedCoOp/data", help="path to dataset")
